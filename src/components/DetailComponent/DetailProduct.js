  ...
  return (
    <div className="wrapper-detail">
      <div className="top-header">
        <img
          width="100%"
          src="/assets/images/products/banner_mirae.png"
          alt="picHeader"
        />
      </div>
        ...
        <div className="main-description">
          <div className="container">
            <div className="bl-description-detail mb-5">
              ...
              <ul>
                <li>
                  Giải pháp tài chính tối ưu cho khách hàng có thu nhập từ
                  4tr/tháng. Chỉ cần CMND đã có thể lên hồ sơ với khoản vay lên
                  tới 70 triệu đồng
                </li>
                <li>Giải ngân nhanh chóng trong 24h qua tài khoản ngân hàng</li>
              </ul>
            </div>
