  ...
  return (
    <div className="wrapper-detail">
      <div className="top-header">
        <img
          width="100%"
          src="/assets/images/products/banner_shb.png"
          alt="picHeader"
        />
      </div>
        ...
        <div className="main-description">
          <div className="container">
            <div className="bl-description-detail mb-5">
              ...
              <ul>
                <li>
                  Nguồn cứu nguy khi lương chưa về dành cho khách hàng có thu
                  nhập từ 4 triệu đồng.
                </li>
                <li>
                  Phê duyệt khoản vay lên tới 70 triệu, giải ngân ngay trong 24h
